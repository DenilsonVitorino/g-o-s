 ...
 * @author dv22p
 */
public class FrmPesqUsuarios extends javax.swing.JDialog 
{
    UsuariosModelo um = new UsuariosModelo();
    UsuariosControle uc = new UsuariosControle();

    /**
     * Creates new form FrmPesqUsuarios
     */
    public FrmPesqUsuarios(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    {
        um.setNome(txtPesq.getText());
        uc.pesqUsuarios(um, tabUsuarios);
    }

    public void setarCampos()
    {
        int setar = tabUsuarios.getSelectedRow();
        FrmUsuarios.txtCodigo.setText(tabUsuarios.getModel().getValueAt(setar, 0).toString());
    } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPesqUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPesqUsuarios dialog = new FrmPesqUsuarios(new javax.swing.JFrame(), true);
